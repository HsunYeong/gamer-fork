...
//-------------------------------------------------------------------------------------------------------
// Function    :  MHD_ResetByUser_BField_WLMDwarfGalaxy
                                              ...
                                              const int i, const int j, const int k )
{
   ...
   if ( UseVecPot )
   {
      switch ( Component )
      {
         case 'x' :  B_out = MHD_ResetByUser_A2Bx( Ax, Ay, Az, i, j, k, dh )/UNIT_B;    break;
         case 'y' :  B_out = MHD_ResetByUser_A2By( Ax, Ay, Az, i, j, k, dh )/UNIT_B;    break;
         case 'z' :  B_out = MHD_ResetByUser_A2Bz( Ax, Ay, Az, i, j, k, dh )/UNIT_B;    break;
         default  :  Aux_Error( ERROR_INFO, "unsupported component (%c) !!\n", Component );
      }
   } // if ( UseVecPot )
   ...
   else
   {
      switch ( Component )
      {
         case 'x' :  B_out = WLMDwarfGalaxy_B0X/UNIT_B;  break;
         case 'y' :  B_out = WLMDwarfGalaxy_B0Y/UNIT_B;  break;
         case 'z' :  B_out = WLMDwarfGalaxy_B0Z/UNIT_B;  break;
         default  :  Aux_Error( ERROR_INFO, "unsupported component (%c) !!\n", Component );
      }
   } // if ( UseVecPot ) ... else ...
